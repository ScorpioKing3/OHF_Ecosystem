...
def run_test(page):
    ...
    # Capture Screenshot in the matchmaking state (should show timer starting from 60s)
    page.screenshot(path="/home/jules/verification/screenshots/matchmaking_start.png")
    page.wait_for_timeout(3000)

    # Cancel search
    page.get_by_text("Cancel Search").click()
    page.wait_for_timeout(1000)
    page.screenshot(path="/home/jules/verification/screenshots/matchmaking_cancel.png")
    page.wait_for_timeout(1000)
